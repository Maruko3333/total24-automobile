...
const T24 = {
  ...
  i18n: {
    de: {
      ...
      'card.details': 'Details ansehen', 'card.wa.aria': 'Auf WhatsApp anfragen', 'card.fav.aria': 'Zu Favoriten hinzufügen',
      'badge.new': 'Neu', 'badge.reserved': 'Reserviert', 'badge.sold': 'Verkauft',
      'card.link': 'Fahrzeug ansehen',
      'spec.power': 'Leistung', 'spec.mileage': 'Kilometerstand', 'spec.fuel': 'Kraftstoff', 'spec.transmission': 'Getriebe', 'spec.year': 'Baujahr', 'spec.body': 'Karosserie', 'spec.firstReg': 'Erstzulassung', 'spec.capacity': 'Hubraum', 'spec.color': 'Farbe', 'spec.doorsSeats': 'Türen / Sitze', 'spec.co2': 'CO₂-Emissionen',
      'unit.ps': 'PS', 'unit.ccm': 'cm³',
      'detail.h.specs': 'Technische Daten', 'detail.h.features': 'Ausstattung', 'detail.h.desc': 'Beschreibung',
      'detail.finance.badge': 'Finanzierung möglich', 'detail.finance.cta': 'jetzt anfragen',
      'detail.trust.1': 'Aus erster Hand — nur ein Vorbesitzer', 'detail.trust.2': 'Scheckheftgepflegt bei der Fachwerkstatt', 'detail.trust.3': 'Klare Historie und vollständige Dokumente',
      'detail.wa': 'Über dieses Fahrzeug sprechen', 'detail.email': 'E-Mail', 'detail.share': 'An einen Freund senden', 'detail.shared': 'Geteilt',
      'detail.mobilede.pre': 'Auch auf Mobile.de veröffentlicht', 'detail.mobilede.link': 'Anzeige auf Mobile.de ansehen',
      'detail.modelguide.pre': 'Ratgeber zu diesem Modell', 'detail.modelguide.suffix': 'mehr erfahren',
      'lead.title': 'Interesse an diesem Fahrzeug?', 'lead.sub': 'Hinterlassen Sie Ihre Daten — wir melden uns mit einem Angebot.', 'lead.name': 'Ihr Name', 'lead.phone': 'Telefon', 'lead.email': 'E-Mail (optional)', 'lead.finance': 'Ich möchte Informationen zur Finanzierung', 'lead.submit': 'Anfrage senden', 'lead.sending': 'Wird gesendet...', 'lead.ok': 'Vielen Dank! Ihre Anfrage wurde gesendet — wir melden uns mit einem Angebot.', 'lead.errPre': 'Senden momentan nicht möglich. Schreiben Sie uns auf', 'lead.errLink': 'WhatsApp',
      'notfound.title': 'Fahrzeug nicht gefunden', 'notfound.link': 'Zum gesamten Bestand →',
      'seo.price': 'Preis', 'detail.seo.suffix': 'Aus erster Hand, geprüft — Total24 Automobile, Fürth.',
      'stoc.sub': 'Wählen Sie aus unseren aktuellen Angeboten.',
      'stoc.filter': 'Filter', 'stoc.f.make': 'Marke', 'stoc.f.model': 'Modell', 'stoc.f.maxprice': 'Höchstpreis', 'stoc.f.upto': 'bis', 'stoc.f.year': 'Baujahr', 'stoc.f.maxkm': 'Max. Kilometerstand', 'stoc.f.any': 'Beliebig', 'stoc.f.km50': 'bis 50.000 km', 'stoc.f.km100': 'bis 100.000 km', 'stoc.f.km150': 'bis 150.000 km', 'stoc.f.km200': 'bis 200.000 km', 'stoc.f.fuel': 'Kraftstoff', 'stoc.f.gear': 'Getriebe', 'stoc.f.body': 'Karosserie', 'stoc.f.apply': 'Filtern', 'stoc.f.reset': 'Filter zurücksetzen', 'stoc.f.allmakes': 'Alle Marken', 'stoc.f.allmodels': 'Alle Modelle',
      'stoc.favs': 'Meine Favoriten', 'stoc.sortby': 'Sortieren:', 'stoc.sort.rec': 'Empfohlen', 'stoc.sort.new': 'Neueste', 'stoc.sort.priceasc': 'Preis aufsteigend', 'stoc.sort.pricedesc': 'Preis absteigend', 'stoc.sort.kmasc': 'Wenig Kilometer',
      'stoc.available.one': 'Fahrzeug verfügbar', 'stoc.available.many': 'Fahrzeuge verfügbar', 'stoc.favorites': 'Favoriten',
      'stoc.empty.fav.title': 'Noch keine Favoriten', 'stoc.empty.fav.text': 'Klicken Sie auf ♥ bei einem Fahrzeug, um es hier zu speichern.', 'stoc.empty.none.title': 'Keine Fahrzeuge gefunden', 'stoc.empty.none.text': 'Passen Sie die Filter an.',
    ...
    en: {
      ...
      'card.details': 'View details', 'card.wa.aria': 'Ask on WhatsApp', 'card.fav.aria': 'Save to favourites',
      'badge.new': 'New', 'badge.reserved': 'Reserved', 'badge.sold': 'Sold',
      'card.link': 'View vehicle',
      'spec.power': 'Power', 'spec.mileage': 'Mileage', 'spec.fuel': 'Fuel', 'spec.transmission': 'Transmission', 'spec.year': 'Year', 'spec.body': 'Body', 'spec.firstReg': 'First registration', 'spec.capacity': 'Displacement', 'spec.color': 'Colour', 'spec.doorsSeats': 'Doors / Seats', 'spec.co2': 'CO₂ emissions',
      'unit.ps': 'hp', 'unit.ccm': 'cc',
      'detail.h.specs': 'Technical data', 'detail.h.features': 'Features', 'detail.h.desc': 'Description',
      'detail.finance.badge': 'Financing available', 'detail.finance.cta': 'enquire now',
      'detail.trust.1': 'First-hand — only one previous owner', 'detail.trust.2': 'Full service history at the workshop', 'detail.trust.3': 'Clear history and complete documents',
      'detail.wa': 'Ask about this vehicle', 'detail.email': 'Email', 'detail.share': 'Send to a friend', 'detail.shared': 'Shared',
      'detail.mobilede.pre': 'Also published on Mobile.de', 'detail.mobilede.link': 'View listing on Mobile.de',
      'detail.modelguide.pre': 'Guide for this model', 'detail.modelguide.suffix': 'learn more',
      'lead.title': 'Interested in this vehicle?', 'lead.sub': "Leave your details — we'll get back to you with an offer.", 'lead.name': 'Your name', 'lead.phone': 'Phone', 'lead.email': 'Email (optional)', 'lead.finance': "I'd like information about financing", 'lead.submit': 'Send request', 'lead.sending': 'Sending...', 'lead.ok': 'Thank you! Your request has been sent — we will get back to you with an offer.', 'lead.errPre': 'Sending is currently not possible. Write to us on', 'lead.errLink': 'WhatsApp',
      'notfound.title': 'Vehicle not found', 'notfound.link': 'View all vehicles →',
      'seo.price': 'Price', 'detail.seo.suffix': 'First-hand, checked — Total24 Automobile, Fürth.',
      'stoc.sub': 'Choose from our current offers.',
      'stoc.filter': 'Filters', 'stoc.f.make': 'Make', 'stoc.f.model': 'Model', 'stoc.f.maxprice': 'Max. price', 'stoc.f.upto': 'up to', 'stoc.f.year': 'Year', 'stoc.f.maxkm': 'Max. mileage', 'stoc.f.any': 'Any', 'stoc.f.km50': 'up to 50,000 km', 'stoc.f.km100': 'up to 100,000 km', 'stoc.f.km150': 'up to 150,000 km', 'stoc.f.km200': 'up to 200,000 km', 'stoc.f.fuel': 'Fuel', 'stoc.f.gear': 'Transmission', 'stoc.f.body': 'Body', 'stoc.f.apply': 'Filter', 'stoc.f.reset': 'Reset filters', 'stoc.f.allmakes': 'All makes', 'stoc.f.allmodels': 'All models',
      'stoc.favs': 'My favourites', 'stoc.sortby': 'Sort by:', 'stoc.sort.rec': 'Recommended', 'stoc.sort.new': 'Newest', 'stoc.sort.priceasc': 'Price ascending', 'stoc.sort.pricedesc': 'Price descending', 'stoc.sort.kmasc': 'Low mileage',
      'stoc.available.one': 'vehicle available', 'stoc.available.many': 'vehicles available', 'stoc.favorites': 'favourites',
      'stoc.empty.fav.title': 'No favourites yet', 'stoc.empty.fav.text': 'Click the ♥ on a vehicle to save it here.', 'stoc.empty.none.title': 'No vehicles found', 'stoc.empty.none.text': 'Try adjusting the filters.',
    ...
    ro: {
      ...
      'card.details': 'Vezi detalii', 'card.wa.aria': 'Întreabă pe WhatsApp', 'card.fav.aria': 'Salvează la favorite',
      'badge.new': 'Nou', 'badge.reserved': 'Rezervat', 'badge.sold': 'Vândut',
      'card.link': 'Vezi mașina',
      'spec.power': 'Putere', 'spec.mileage': 'Kilometraj', 'spec.fuel': 'Combustibil', 'spec.transmission': 'Transmisie', 'spec.year': 'An', 'spec.body': 'Caroserie', 'spec.firstReg': 'Prima înmatriculare', 'spec.capacity': 'Capacitate', 'spec.color': 'Culoare', 'spec.doorsSeats': 'Uși / Locuri', 'spec.co2': 'Emisii CO₂',
      'unit.ps': 'CP', 'unit.ccm': 'cm³',
      'detail.h.specs': 'Date tehnice', 'detail.h.features': 'Dotări', 'detail.h.desc': 'Descriere',
      'detail.finance.badge': 'Finanțare posibilă', 'detail.finance.cta': 'cere acum',
      'detail.trust.1': 'Din prima mână — un singur proprietar', 'detail.trust.2': 'Istoric complet de service la atelier', 'detail.trust.3': 'Istoric clar și documente complete',
      'detail.wa': 'Întreabă despre această mașină', 'detail.email': 'E-mail', 'detail.share': 'Trimite unui prieten', 'detail.shared': 'Trimis',
      'detail.mobilede.pre': 'Publicat și pe Mobile.de', 'detail.mobilede.link': 'Vezi anunțul pe Mobile.de',
      'detail.modelguide.pre': 'Ghid pentru acest model', 'detail.modelguide.suffix': 'află mai mult',
      'lead.title': 'Te interesează această mașină?', 'lead.sub': 'Lasă-ne datele — te contactăm cu o ofertă.', 'lead.name': 'Numele tău', 'lead.phone': 'Telefon', 'lead.email': 'Email (opțional)', 'lead.finance': 'Doresc informații despre finanțare', 'lead.submit': 'Trimite cererea', 'lead.sending': 'Se trimite...', 'lead.ok': 'Mulțumim! Cererea ta a fost trimisă — te contactăm cu o ofertă.', 'lead.errPre': 'Trimiterea nu este posibilă momentan. Scrie-ne pe', 'lead.errLink': 'WhatsApp',
      'notfound.title': 'Mașina nu a fost găsită', 'notfound.link': 'Vezi tot stocul →',
      'seo.price': 'Preț', 'detail.seo.suffix': 'Din prima mână, verificată — Total24 Automobile, Fürth.',
      'stoc.sub': 'Alege dintre ofertele noastre actuale.',
      'stoc.filter': 'Filtre', 'stoc.f.make': 'Marcă', 'stoc.f.model': 'Model', 'stoc.f.maxprice': 'Preț maxim', 'stoc.f.upto': 'până la', 'stoc.f.year': 'An', 'stoc.f.maxkm': 'Kilometraj maxim', 'stoc.f.any': 'Oricare', 'stoc.f.km50': 'până la 50.000 km', 'stoc.f.km100': 'până la 100.000 km', 'stoc.f.km150': 'până la 150.000 km', 'stoc.f.km200': 'până la 200.000 km', 'stoc.f.fuel': 'Combustibil', 'stoc.f.gear': 'Cutie', 'stoc.f.body': 'Caroserie', 'stoc.f.apply': 'Filtrează', 'stoc.f.reset': 'Resetează filtrele', 'stoc.f.allmakes': 'Toate mărcile', 'stoc.f.allmodels': 'Toate modelele',
      'stoc.favs': 'Favoritele mele', 'stoc.sortby': 'Sortează:', 'stoc.sort.rec': 'Recomandate', 'stoc.sort.new': 'Cele mai noi', 'stoc.sort.priceasc': 'Preț crescător', 'stoc.sort.pricedesc': 'Preț descrescător', 'stoc.sort.kmasc': 'Kilometraj mic',
      'stoc.available.one': 'mașină disponibilă', 'stoc.available.many': 'mașini disponibile', 'stoc.favorites': 'favorite',
      'stoc.empty.fav.title': 'Nu ai favorite încă', 'stoc.empty.fav.text': 'Apasă ♥ pe o mașină ca s-o salvezi aici.', 'stoc.empty.none.title': 'Nicio mașină găsită', 'stoc.empty.none.text': 'Încearcă să ajustezi filtrele.',
